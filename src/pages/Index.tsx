...
const Index = () => {
  return (
    <div className="min-h-screen relative">
      <div className="minecraft-bg fixed inset-0 z-0"></div>
      <div className="relative z-10">
        ...
        {/* Features Section */}
        <section id="features" className="py-20 px-4 bg-gray-900/50 backdrop-blur-md">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="p-6 rounded-2xl bg-gray-800/50 border border-gray-700 hover:bg-gray-800/70 transition-all duration-300 animate-fade-up backdrop-blur-sm hover:shadow-xl"
        ...
        {/* Pricing Section */}
        <section id="pricing" className="py-20 px-4 bg-gray-900/50 backdrop-blur-md">
          <div className="container mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 max-w-7xl mx-auto">
              {plans.map((plan, index) => (
                <div
                  ...
                  } border hover:bg-gray-800/70 transition-all duration-300 animate-fade-up hover:shadow-xl`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  {plan.popular && (
